...
@section('script')
    <script>
        $(document).ready(function(){
            const options = {};
            options.url = '{{ route("categories.all-categories") }}';
            options.type = 'GET';
            options.columns = 
                    [
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let edit = `{{ route('categories.edit', ":id") }}`.replace(':id', row.id);
                                let destroy = `{{ route('categories.destroy', ":id") }}`.replace(':id', row.id);
