...
@section('script')
    <script>
        $(document).ready(function(){
            const options = {};
            options.url = '{{ route("transfer-requisitions.incoming-tr-list") }}';
            options.type = 'GET';
            options.columns = 
                    [
                        { data: null, orderable: false, searchable: false },
                        { data: 'tr_no', name: 'transfer_requisitions.tr_no'},
                        { data: 'by_branch_title', name: 'by_branch.title'},
                        ...
                        { data: 'created_by', name: 'by_branch_admin.name'},
                        { 
                            data: null, 
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let edit = `{{ route('transfer-requisitions.edit-incoming', ":id") }}`.replace(':id', row.id);
