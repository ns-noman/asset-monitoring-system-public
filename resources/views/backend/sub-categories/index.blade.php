...
@section('script')
    <script>
        $(document).ready(function(){
            const options = {};
            options.url = '{{ route("sub-categories.all-sub-categories") }}';
            options.type = 'GET';
            options.columns = 
                    [
                        { data: null, orderable: false, searchable: false },
                        { data: 'title', name: 'subcategory.title'},
                        { data: 'parent_title', name: 'parent_categories.parent_title'},
                        { 
                            data: null, 
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let edit = `{{ route('sub-categories.edit', ":id") }}`.replace(':id', row.id);
                                let destroy = `{{ route('sub-categories.destroy', ":id") }}`.replace(':id', row.id);
